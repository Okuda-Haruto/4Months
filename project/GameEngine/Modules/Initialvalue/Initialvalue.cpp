...
//PSOを生成する
Microsoft::WRL::ComPtr <ID3D12PipelineState> TriangleRenderPipelineStateInitialvalue(ID3D12Device* device,
	Microsoft::WRL::ComPtr <ID3D12RootSignature> rootSignature,
	IDxcBlob* vertexShaderBlob,
	IDxcBlob* pixelShaderBlob)
{
...
//PSOを生成する
Microsoft::WRL::ComPtr <ID3D12PipelineState> AddBlendTrianglePipelineStateInitialvalue(ID3D12Device* device,
	Microsoft::WRL::ComPtr <ID3D12RootSignature> rootSignature,
	IDxcBlob* vertexShaderBlob,
	IDxcBlob* pixelShaderBlob) 
{
...
//PSOを生成する
Microsoft::WRL::ComPtr <ID3D12PipelineState> SpriteAdditivePipelineStateInitialvalue(ID3D12Device* device,
	Microsoft::WRL::ComPtr <ID3D12RootSignature> rootSignature,
	IDxcBlob* vertexShaderBlob,
	IDxcBlob* pixelShaderBlob)
{
	//InputLayoutの作成（SpritePipelineStateInitialvalue と同じ）
	D3D12_INPUT_ELEMENT_DESC inputElementDescs[3] = {};
	inputElementDescs[0].SemanticName = "POSITION";
	inputElementDescs[0].SemanticIndex = 0;
	inputElementDescs[0].Format = DXGI_FORMAT_R32G32B32A32_FLOAT;
...
Microsoft::WRL::ComPtr <ID3D12PipelineState> GlowPipelineStateInitialvalue(ID3D12Device* device,
	Microsoft::WRL::ComPtr <ID3D12RootSignature> rootSignature,
	IDxcBlob* vertexShaderBlob,
	IDxcBlob* pixelShaderBlob) {
	//InputLayoutの作成
